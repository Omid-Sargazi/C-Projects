...
namespace ServiceProvider
{
    class Program
    {
        ...
        {
            // Step 4: Set up Dependency Injection and ServiceProvider
            ...
            // var customerList = addedCustomer.GetType().GetMethod("Add")?.Invoke(addedCustomer, null);
...
// Display a success message
        ...
        Console.WriteLine($"Name: {customer.Name}, Email: {customer.Email}");
            ...
            Console.WriteLine("Customer added successfully!");
            var addMethod = addedCustomer.GetType().GetMethod("Add");
addMethod?.Invoke(addedCustomer, new object[] { customer });
